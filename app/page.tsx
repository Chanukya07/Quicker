...
export default function Home() {
  return (
    <main id="main-content" tabIndex={-1}>
      ...
      <section className="heroLanding shell">
        <div className="heroCopy">
          ...
          <div className="heroActions">
            <Link className="primaryCta" href="/demo"><Sparkles size={18} /> Explore live demo <ArrowRight size={17} /></Link>
            <a className="textCta" href="#how-it-works">See how it works <span>↓</span></a>
          </div>
      ...
      <section className="finalCta shell"><div><span className="sectionKicker">SEE IT IN ACTION</span><h2>Make sense of your spending.</h2><p>Explore a realistic workspace with sample receipt data.</p></div><Link className="primaryCta light" href="/demo"><Sparkles size={18}/> Open interactive demo <ArrowRight size={17}/></Link></section>
